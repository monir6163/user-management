...
export default auth(async (req) => {
  ...
  // super admin role can not access both admin and user routes
  ...
  // admin and user role can not access super admin route
  if (
    nextUrl.pathname.startsWith("/dashboard/super-admin") &&
    userRole?.user.role !== "SUPER_ADMIN"
  ) {
    return Response.redirect(new URL("/dashboard", nextUrl));
  }
